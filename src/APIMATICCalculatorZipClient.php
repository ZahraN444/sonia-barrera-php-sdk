...
use APIMATICCalculatorZipLib\Controllers\SimpleCalculatorController;
use APIMATICCalculatorZipLib\Proxy\ProxyConfigurationBuilder;
use APIMATICCalculatorZipLib\Utils\CompatibilityConverter;
use Core\ClientBuilder;
use Core\Utils\CoreHelper;
use Unirest\Configuration;
use Unirest\HttpClient;

class APIMATICCalculatorZipClient implements ConfigurationInterface
{
    ...
    /**
     * @see APIMATICCalculatorZipClientBuilder::init()
     * @see APIMATICCalculatorZipClientBuilder::build()
     *
     * @param array $config
     */
     ...
     *
     * @return APIMATICCalculatorZipClientBuilder APIMATICCalculatorZipClientBuilder instance
     */
    public function toBuilder(): APIMATICCalculatorZipClientBuilder
    {
        return APIMATICCalculatorZipClientBuilder::init()
     ...
     *
     * @see APIMATICCalculatorZipClientBuilder::getConfiguration()
     */
    ...
    private const ENVIRONMENT_MAP =
        [Environment::PRODUCTION => [Server::DEFAULT_ => 'https://examples.apimatic.io/apps/calculator']];
}
